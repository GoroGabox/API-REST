"""Servicios de gamificación: XP, streak, logros.

Diseño:
- Vidas (hearts): eliminadas. Ni las pruebas ni el examen final consumen ni
  exigen recursos; el examen final tampoco tiene espera entre intentos.
